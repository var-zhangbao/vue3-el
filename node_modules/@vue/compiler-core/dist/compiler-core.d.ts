...
export declare const enum ErrorCodes {
    ...
    X_V_BIND_NO_EXPRESSION = 32,
    X_V_ON_NO_EXPRESSION = 33,
    X_V_SLOT_UNEXPECTED_DIRECTIVE_ON_SLOT_OUTLET = 34,
    X_V_SLOT_MIXED_SLOT_USAGE = 35,
    X_V_SLOT_DUPLICATE_SLOT_NAMES = 36,
    X_V_SLOT_EXTRANEOUS_DEFAULT_SLOT_CHILDREN = 37,
    X_V_SLOT_MISPLACED = 38,
    X_V_MODEL_NO_EXPRESSION = 39,
    X_V_MODEL_MALFORMED_EXPRESSION = 40,
    X_V_MODEL_ON_SCOPE_VARIABLE = 41,
    X_INVALID_EXPRESSION = 42,
    X_KEEP_ALIVE_INVALID_CHILDREN = 43,
    X_PREFIX_ID_NOT_SUPPORTED = 44,
    X_MODULE_MODE_NOT_SUPPORTED = 45,
    X_CACHE_HANDLER_NOT_SUPPORTED = 46,
    X_SCOPE_ID_NOT_SUPPORTED = 47,
    __EXTEND_POINT__ = 48
}
