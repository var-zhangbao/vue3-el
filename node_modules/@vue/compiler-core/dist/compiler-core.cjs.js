...
asRawStatements = false) {
    ...
    try {
        ...
        context.onError(createCompilerError(42 /* X_INVALID_EXPRESSION */, node.loc, undefined, e.message));
        return node;
    }
    const ids = [];
...
const transformModel = (dir, node, context) => {
    ...
    if (
        ...
        context.onError(createCompilerError(41 /* X_V_MODEL_ON_SCOPE_VARIABLE */, exp.loc));
        return createTransformProps();
    }
